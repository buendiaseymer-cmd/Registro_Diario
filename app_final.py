...
# ---- CONEXIÓN A GOOGLE SHEETS (SE EJECUTA UNA SOLA VEZ POR SESIÓN) ----
@st.cache_resource
...
# ---- CARGA DE LISTA DE PERSONAL DESDE GOOGLE SHEETS ----
...
# ---- BOTÓN DE ACTUALIZACIÓN MANUAL (SIDEBAR) ----
with st.sidebar:
...
with tab2:
    ...
    if enviado_prod:
        if not jefe_grupo_prod or not tramo_prod or not frente_prod:
            ...
            # ... (el resto del guardado y formato se mantiene exactamente igual)
